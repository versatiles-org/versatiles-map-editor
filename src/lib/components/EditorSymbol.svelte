...
<InputRow id="size" label="Size">
	<input id="size" type="range" min="0.5" max="3" step="0.1" bind:value={$size} onchange={log} />
</InputRow>

<InputRow id="rotate" label="Rotation">
	<input id="rotate" type="range" min="-180" max="180" step="15" bind:value={$rotate} onchange={log} />
</InputRow>

<InputRow id="halo" label="Halo">
	<input id="halo" type="range" min="0" max="3" step="0.5" bind:value={$halo} onchange={log} />
</InputRow>

<InputRow id="label" label="Label">
	<input id="label" type="label" bind:value={$label} onchange={log} />
</InputRow>

<InputRow id="labelAlign" label="Align Label">
	<select id="labelAlign" bind:value={$labelAlign} onchange={log}>
